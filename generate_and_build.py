...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import TypelessSEOOptimizer
        ...
        optimizer = TypelessSEOOptimizer(config)
    ...
    try:
        from site_generator import TypelessSiteGenerator
        site_gen = TypelessSiteGenerator(config)
        site_gen.build_site()
